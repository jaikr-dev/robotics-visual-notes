...
\title{\textbf{Gr\"{u}bler's Formula: Degrees of Freedom of a Mechanism}}
...
\begin{figure}[H]
    \centering
    \adjustbox{frame}{\includegraphics[width=0.5\linewidth]{planar-mechanism.png}}
...
\noindent\textit{I built an interactive walkthrough of Grübler's formula that lets you step through the three stages visually, explore different joint types, and see a case where the formula breaks down. Available at: \url{https://jaikr-dev.github.io/robotics-visual-notes/##/grublers-formula}}
